...
class ServiceController extends Controller
{
    ...
    {
        $this->padProblems= [
            "X or O or SQUARE or TRIANGLE or all are not working","R1 or L1 or L2 or R2 or all are not working","Player keeps going in one direction or Left Analog keeps going in one direction","Analog is stiff or hard to use","Right analog problem","Pad is not charging","Pad is charging but not coming on","Pad is not charging and is not coming on ","Pad is coming on but not connecting to the console"
        ];
    ...
    public function showCompletionForm(){
        return view('service',['states'=>$this->locationStates, 'cart'=> Cart::content(),'servicePrice'=>$this->getServicePrice()]);
    }
